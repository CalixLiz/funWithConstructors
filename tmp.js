...
// -- ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ - Your Answer - ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ -- //
var Dog = function() {
    this.philosophy = function(philosophyInput){
        return philosophyInput
    }
}

var dog = new Dog()
dog.philosophy('life is ruff')
...
// -- ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ - Your Answer - ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ -- //
var Student = function(expInput) {
    this.expertise = expInput
    this.knowledge = 0
    
}

Student.prototype.learn = function(knowInput) {
    this.knowledgeGain = this.knowledge + knowInput
        return this.knowledgeGain
}
...
var Safe = function() {
    this.num = 123
    this.value = 'Your key works'
}

Safe.prototype.unlock = function(num) {
    if(this.num === num) {
        return this.value
    }
}
...
var Validator = function() {
    this.isEmail = function(str) {
        ...
        for(var i =0; i < str.length; i++) {
            if(this.value === str[i]) return true
        }
        return false
    } 
...
var user = new Validator

user.isEmail('lola@gmail.com')
